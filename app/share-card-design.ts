...
export type ShareTemplate='editorial'|'route'|'split'|'signature'|'serif'|'laps'|'bib'|'strip'|'outline'|'receipt'|'chrono';
...
export function shareCardSvg(o:ShareDesign){
 ...
 if(o.route&&!['route','laps','outline'].includes(o.template))parts.push(route(840,100,165,165,3));
